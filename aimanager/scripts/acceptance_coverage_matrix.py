...
DEFAULT_GATE_REGISTRY: tuple[AcceptanceGate, ...] = (
    ...
    AcceptanceGate("AC-08", "architecture/security", "local_test", ("aimanager/governance.py", "aimanager/tests/test_governance.py", "aimanager/tests/test_admin_ui_key_creation_smoke.py")),
